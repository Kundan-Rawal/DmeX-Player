    ...
    <div className="ambient-background">
      {(visMode === 'ORBIT' || (IS_ANDROID && visMode === 'RADAR')) ? (
        ...
        <div style={{position:'absolute',inset:0,'--ring-core':isDarkMode?'rgba(255,255,255,0.9)':'var(--theme-color)'} as React.CSSProperties}>
          <div ref={cornerTLRef} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?1.0:0.85,zIndex:0,top:'5%',left:'5%',width:(!isDarkMode && IS_ANDROID ? '80vw' : '50vw'),height:(!isDarkMode && IS_ANDROID ? '80vw' : '50vw'),background:'radial-gradient(circle, var(--blob-1) 0%, transparent 65%)',willChange:'transform'}}/>
          <div ref={cornerBRRef} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?1.0:0.85,zIndex:0,bottom:'5%',right:'5%',width:(!isDarkMode && IS_ANDROID ? '72vw' : '45vw'),height:(!isDarkMode && IS_ANDROID ? '72vw' : '45vw'),background:'radial-gradient(circle, var(--blob-2) 0%, transparent 65%)',willChange:'transform'}}/>
          <div ref={cornerTRRef} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?1.0:0.85,zIndex:0,top:'5%',right:'5%',width:(!isDarkMode && IS_ANDROID ? '56vw' : '35vw'),height:(!isDarkMode && IS_ANDROID ? '56vw' : '35vw'),background:'radial-gradient(circle, var(--blob-3) 0%, transparent 65%)',willChange:'transform'}}/>
          <div ref={cornerBLRef} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?1.0:0.85,zIndex:0,bottom:'5%',left:'5%',width:(!isDarkMode && IS_ANDROID ? '64vw' : '40vw'),height:(!isDarkMode && IS_ANDROID ? '64vw' : '40vw'),background:'radial-gradient(circle, var(--theme-color) 0%, transparent 65%)',willChange:'transform'}}/>
          <div ref={blob5Ref} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?0.8:0.65,zIndex:0,top:'20%',left:'30%',width:(!isDarkMode && IS_ANDROID ? '56vw' : '35vw'),height:(!isDarkMode && IS_ANDROID ? '56vw' : '35vw'),background:'radial-gradient(circle, var(--blob-2) 0%, transparent 65%)',willChange:'transform'}}/>
          <div ref={blob6Ref} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?0.8:0.65,zIndex:0,bottom:'20%',right:'30%',width:(!isDarkMode && IS_ANDROID ? '64vw' : '40vw'),height:(!isDarkMode && IS_ANDROID ? '64vw' : '40vw'),background:'radial-gradient(circle, var(--blob-1) 0%, transparent 65%)',willChange:'transform'}}/>
          <div ref={blob7Ref} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?0.8:0.65,zIndex:0,top:'35%',right:'15%',width:(!isDarkMode && IS_ANDROID ? '60vw' : '38vw'),height:(!isDarkMode && IS_ANDROID ? '60vw' : '38vw'),background:'radial-gradient(circle, var(--theme-color) 0%, transparent 65%)',willChange:'transform'}}/>
          <div ref={blob8Ref} style={{position:'absolute',mixBlendMode:isDarkMode?'normal':'multiply',opacity:isDarkMode?0.8:0.65,zIndex:0,bottom:'35%',left:'15%',width:(!isDarkMode && IS_ANDROID ? '80vw' : '50vw'),height:(!isDarkMode && IS_ANDROID ? '80vw' : '50vw'),background:'radial-gradient(circle, var(--blob-3) 0%, transparent 65%)',willChange:'transform'}}/>
